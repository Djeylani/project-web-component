...
(function() {
  class EditableList extends HTMLElement {
    ...
    connectedCallback() {
        const removerElementButtons = [...this.shadowRoot.querySelectorAll('.editable-list-remove-item')];
        const addElementButton = this.shadowRoot.querySelector(".editable-list-add-item");

        this.itemList = this.shadowRoot.querySelector(".item-list");

        this.handleRemoveItemListeners(removerElementButtons);
